...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Interessado', function() {
      beforeEach(function() {
        instance = new ApiDocumentation.Interessado();
      });

      it('should create an instance of Interessado', function() {
        // TODO: update the code to test Interessado
        expect(instance).to.be.a(ApiDocumentation.Interessado);
      });
