...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Assunto', function() {
      beforeEach(function() {
        instance = new ApiDocumentation.Assunto();
      });

      it('should create an instance of Assunto', function() {
        // TODO: update the code to test Assunto
        expect(instance).to.be.a(ApiDocumentation.Assunto);
      });
